function jakenet_flipNoise_train(varargin)
...
opts.expDir = fullfile(opts.dataDir, 'jakenet-flipNoise', ...
...
if ~opts.batchNormalization
  ...
  factors = [2, 2, 2, 2, 2, 1.5, 1.5, 1, 1, 1, ...
             0.8, 0.6, 0.4, 0.2, 0.2, 0.2, 0.1, 0.1, 0.1, 0.1];
  opts.train.learningRate = rate .* factors;
  opts.train.learningRate(21:30) = logspace(-4,-5,10);
end
[opts, varargin] = vl_argparse(opts, varargin) ;
...
im = get_batch_flipNoise(images, opts, ...
                            'prefetch', nargout == 0) ;
