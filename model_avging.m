...
files = [fopen('nets/jakenet-aug8flip-refnet3/val-predictions-30.txt'), ...
    fopen('nets/jakenet-aug4flip/val-predictions-30.txt'), ...
    fopen('nets/jakenet/val-predictions-20.txt'), ...
    fopen('nets/alexnet1/val-predictions-21.txt'), ...
    fopen('nets/jamar7/val-predictions-20.txt'), ...
    fopen('nets/jakenet-flipNoise/val-predictions-30.txt')];
